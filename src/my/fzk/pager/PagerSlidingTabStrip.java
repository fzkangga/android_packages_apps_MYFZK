...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int mTabBackgroundResId = R.drawable.fzk_back_tab;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabsColor = context.getResources().getColor(R.color.fzk_pager_accent);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (isCustomTabs) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.fzk_tab, this, false);
            }
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tab_title != null) {
                tab_title.setTextColor(getResources().getColor(R.color.fzk_config_tab_text_color));
